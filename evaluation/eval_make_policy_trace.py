...
print("=========================================================")
print("=== 1. CONSTRUCTING POLICY WITH REAL DATASET METADATA ===")
print("=========================================================")
...
print(f"Dataset stats keys: {list(ds_meta.stats.keys())}")
...
# Instantiate policy using make_policy with real ds_meta attached
