...
print("=========================================================")
print("=== 1. CLEAN RUNTIME POLICY & PROCESSOR INITIALIZATION ===")
print("=========================================================")
...
print("✅ Policy Model loaded onto GPU!")

# Instantiate external preprocessor and postprocessor pipelines
preprocessor, postprocessor = make_pre_post_processors(
    policy_cfg=cfg,
    pretrained_path=CHECKPOINT_PATH,
    dataset_stats=ds_meta.stats
)
print("✅ Preprocessor & Postprocessor pipelines loaded!")
...
print("\n=========================================================")
print("=== 2. SINGLE EPISODE ROLLOUT (SEED 1000) DIAGNOSTIC ===")
print("=========================================================")
