...
print("\n--- UNMODIFIED RAW MODEL INFERENCE TRACE (SEED 1000) ---")
print("Step | TCP Position (x, y, z)       | Pure Unmodified Model Action Output (7D)")
print("-" * 75)
...
for step in range(15):
    ...
    # Pure unmodified action step (NO thresholds, NO sign inversions, NO overrides)
