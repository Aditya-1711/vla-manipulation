...
print("=========================================================")
print("=== 1. CONSTRUCTING POLICY + PRE/POST PROCESSORS VIA LEROBOT.POLICIES ===")
print("=========================================================")
...
# Instantiate policy using top-level make_policy export
policy = make_policy(cfg=cfg, ds_meta=ds_meta, rename_map={"observation.image": "observation.images.camera1"})
policy.eval()
if torch.cuda.is_available():
    policy = policy.to("cuda")

# Construct external preprocessor and postprocessor using top-level make_pre_post_processors export
...
print("\n--- PROCESSOR PIPELINES SUCCESSFULLY CREATED ---")
...
print("\n=========================================================")
print("=== 2. SINGLE EPISODE ROLLOUT (SEED 1000) WITH OFFICIAL PIPELINE ===")
print("=========================================================")
